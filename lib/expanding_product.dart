...
class ExpandingProduct extends StatefulWidget {
  const ExpandingProduct({Key key, @required this.hideController})
  ...
  @override
  _ExpandingProductState createState() => _ExpandingProductState();

  static _ExpandingProductState of(BuildContext context,
      {bool isNullOk: false}) {
    assert(isNullOk != null);
    assert(context != null);
    final _ExpandingProductState result = context
        .ancestorStateOfType(const TypeMatcher<_ExpandingProductState>());
...
class _ExpandingProductState extends State<ExpandingProduct> with TickerProviderStateMixin {
